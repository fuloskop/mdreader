...
const translations: Record<Locale, Translations> = {
  en: {
    ...
    supported: "Drop, choose, or Ctrl+V to paste",
  ...
  tr: {
    ...
    supported: "Sürükle, seç veya Ctrl+V ile yapıştır",
  ...
  es: {
    ...
    supported: "Arrastra, elige o Ctrl+V para pegar",
  ...
  fr: {
    ...
    supported: "Glisser, choisir ou Ctrl+V pour coller",
  ...
  de: {
    ...
    supported: "Ziehen, wählen oder Ctrl+V zum Einfügen",
  ...
  pt: {
    ...
    supported: "Arraste, escolha ou Ctrl+V para colar",
  ...
  ru: {
    ...
    supported: "Перетащите, выберите или Ctrl+V",
  ...
  ja: {
    ...
    chooseFile: "ファイルを選択",
    supported: "ドラッグ、選択、またはCtrl+Vで貼り付け",
  ...
  ko: {
    ...
    chooseFile: "파일 선택",
    supported: "드래그, 선택 또는 Ctrl+V로 붙여넣기",
  ...
  ar: {
    ...
    supported: "اسحب أو اختر أو Ctrl+V للصق",
  ...
  hi: {
    ...
    supported: "खींचें, चुनें या Ctrl+V से चिपकाएँ",
  ...
  it: {
    ...
    supported: "Trascina, scegli o Ctrl+V per incollare",
  ...
  nl: {
    ...
    supported: "Sleep, kies of Ctrl+V om te plakken",
  ...
  pl: {
    ...
    supported: "Przeciągnij, wybierz lub Ctrl+V",
  ...
  uk: {
    ...
    supported: "Перетягніть, оберіть або Ctrl+V",
  ...
  sv: {
    ...
    chooseFile: "Välj fil",
    supported: "Dra, välj eller Ctrl+V för att klistra in",
  ...
  id: {
    ...
    supported: "Seret, pilih, atau Ctrl+V untuk menempel",
